import fs from 'fs';
import type { ResponseLike } from 'miriam-example-2/internal/to-file';
import { toFile } from 'miriam-example-2/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('miriam-example-2/core/uploads');
    await expect(
